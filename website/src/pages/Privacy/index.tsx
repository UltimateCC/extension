...
function Privacy() {
    return (
        <section className="theme-box">
            ...
            <p>We collect the following personnally identifiable data:</p>
            <ul>
                <li>email address</li>
                <li>usage data</li>
            </ul>
            ...
            <ul>
                <li>Login on the website using Twitch.</li>
            ...
            <p>
                If you are located outside France and choose to provide information to us, please note that we transfer the data,
                including Personal Data, to France and process it there. 
            </p>
            ...
            <p>
                Our website contains links to other websites. Our privacy policy applies only to our website,
